                          ...
                          <th className="w-[100px] border-t border-b border-r text-[12px] font-bold text-[#212325] text-left">
                            <div className="flex flex-1 items-center justify-between gap-1 px-2">
                              ...
                              <div className="flex flex-col items-end">
                               ...
                               { (getTotal() === 0)? <div className="text-[10px] italic font-normal">{(((e.total / 8).toFixed(2) / getTotal()) * 100).toFixed(2)}%</div>: <div className="text-[10px] italic font-normal">0.0%</div>}
                              </div>
                            </div>
                          </th>
                          {e.detail.map((f, j) => {
